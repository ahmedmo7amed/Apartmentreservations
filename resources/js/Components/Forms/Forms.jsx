                ...
                <div className="row g-5">
                    <div className="col-lg-12 mt-5">
                        <div
                            ...
                            <div className="inner">
                                {/* العنوان */}
                                <h4 className="rbt-title-style-3 mb--20">Booking Details</h4>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div className="flex space-x-4">
                                        ...
                                        <div className="flex-1">
                                            <label htmlFor="end_date"
                                                   className="block text-sm font-medium text-gray-700">End Date</label>
                                            <input
                                                type="date"
                                                name="end_date"
                                                id="end_date"
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center">
                                            <span className="mr-2 text-sm text-gray-700">Room</span>
                                        ...
                                        <div>
                                            <label htmlFor="guests"
                                                   className="block text-sm font-medium text-gray-700">Guests</label>
                                            <input
                                                type="number"
                                                name="guests"
                                                id="guests"
