                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div className="footer-widget">
                                    ...
                                    <form className="newsletter-form mt--20" action="#">
                                        ...
                                        <p className="description">2000+ Our students are subscribe Around the
                                            World.<br/> Don’t be shy introduce yourself!</p>
                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-12">
                                <p className="rbt-link-hover text-center text-lg-start">Copyright © 2023 <a
